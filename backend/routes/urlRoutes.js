...
import { shortenUrl, getAllUrls, redirectUrl, verifyPassword, toggleUrlStatus, resetPasswordAttempts, cleanupExpiredUrls } from '../controllers/urlController.js';
...
router.delete('/cleanup', authenticate, cleanupExpiredUrls);
